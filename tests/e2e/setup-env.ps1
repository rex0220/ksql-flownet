...
foreach ($n in 'KSQL_SPIKE_TOKEN_EXEC','KSQL_SPIKE_TOKEN_AUDIT','KSQL_E2E_TOKEN_LOGS','KSQL_E2E_TOKEN_LOGS_RO','KSQL_E2E_TOKEN_REQUESTS','KSQL_E2E_TOKEN_REQUESTS_RO') {
