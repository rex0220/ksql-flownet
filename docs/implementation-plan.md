...
**進捗(2026-08-31)**: PRE-01/02/06はR3ラウンド完了(実機E2E m8-01〜03合格、証跡`docs/test-results/r3-pre-round-20260831/`、受入29〜31追加)。残るはPRE-03/04(案A v0+一次対応1ページ)とPRE-05(候補業務2〜3本の指名待ち)。
